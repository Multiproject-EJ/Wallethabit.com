...
| Area | Progress | Notes |
|------|----------|------|
| Overall Build | ![p](https://progress-bar.dev/30/) | Landing, dashboard, and integration scaffolds |
...
| UI/UX | ![p](https://progress-bar.dev/25/) | Home, dashboard, pricing copy drafted |
